...
export default function NavButton({ to, name, external }: Props) {
	...
	return (
		<Link
			className={`flex md:btn md:btn-nav md:py-2 max-md:py-[10px] max-md:pl-[16px] max-md:w-[160px] max-md:text-left md:w-full hover:bg-menu-hover hover:text-menu-text font-medium ${
