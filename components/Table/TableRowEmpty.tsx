...
export default function TableRowEmpty({ children }: Props) {
	return (
		<div className="bg-table-row-primary md:hover:bg-table-row-hover py-8 max-md:px-8 md:px-16 xl:px-20 border-table-row-hover last:rounded-b-lg duration-300">
