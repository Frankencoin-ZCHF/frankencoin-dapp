			...
			<AppHeroSteps
				steps={[
					...
					},
					{
						...
						description: "FPS holders capture fees generated by the protocol — value grows with ecosystem usage.",
					},
					{
						icon: 3,
						title: "Redeem anytime",
						description: "Burn your FPS to withdraw the underlying ZCHF value at the current pool price.",
					},
				]}
			/>
