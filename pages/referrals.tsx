	...
	return (
		<main className="container-xl mx-auto">
			...
			<div className="md:mt-10 flex flex-col gap-12">
				...
				<BonusHistoryTable data={Array(10).fill({ payout: "256.12", source:"Minting", date: "22 Jan 2025", txId: "0x880d1ab3ee32e6a721312677abdada4bf9e0e40961e16af297932e12dadae3c5" })} />
				<FAQ />
			</div>
		</main>
	);
